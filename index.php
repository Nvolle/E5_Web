        ...
        <?php
            ...
            if (isset($_SESSION['email'])) {
                echo '
                    ...
                    <a href="index.php?page=1"><img src="images/classes.png" height="100" width="100"></a>
                    <a href="index.php?page=2"><img src="images/professeurs.png" height="100" width="100"></a>
                    <a href="index.php?page=3"><img src="images/etudiants.png" height="100" width="100"></a>
                    <a href="index.php?page=4"><img src="images/enseignements.png" height="100" width="100"></a>
                    <a href="index.php?page=5"><img src="images/deconnexion.png" height="100" width="100"></a>
                ';
            }
